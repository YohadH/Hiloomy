...
const OPS = new Set(["move", "split", "merge", "exclude", "include", "link_event", "unlink_event", "link_entity", "unlink_entity", "unlink_kind", "unlink_bulk", "set_fact", "set_intent", "clear_intent", "reject_entity", "unreject_entity", "reset"]);
...
export async function POST(request: Request, context: { params: Promise<{ sheetId: string }> }) {
  try {
    ...
    if ((body.op === "link_entity" || body.op === "unlink_entity" || body.op === "unlink_kind" || body.op === "unlink_bulk" || body.op === "set_fact" || body.op === "set_intent" || body.op === "clear_intent" || body.op === "reject_entity" || body.op === "unreject_entity") && typeof (body as { initiativeId?: string }).initiativeId === "string") {
