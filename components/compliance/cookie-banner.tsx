    ...
    >
      <div className="rounded-2xl border border-border bg-card p-4 shadow-2xl">
        <div className="flex items-start gap-3">
          <div className="rounded-lg bg-green-100 p-1.5 text-green-700 shrink-0">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row-reverse sm:justify-start">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-green-700 px-4 py-2 text-xs font-semibold text-white hover:bg-green-800"
          >
            {t.accept}
          </button>
          <button
