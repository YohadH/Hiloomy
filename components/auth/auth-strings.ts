...
export const authStrings = {
  he: {
    ...
    signup: {
      ...
      signinLink: "התחברו",
      termsCheckbox: "קראתי ואני מסכים/ה ל",
      ...
      errors: {
        ...
        passwordWeak: "הסיסמה חייבת לכלול לפחות 8 תווים, אות גדולה אחת ומספר אחד.",
        passwordMismatch: "הסיסמאות לא תואמות.",
        termsRequired: "יש לאשר את תנאי השירות ומדיניות הפרטיות.",
  ...
  en: {
    ...
    signup: {
      ...
      signinLink: "Sign in",
      termsCheckbox: "I've read and agree to the",
      ...
      errors: {
        ...
        passwordWeak: "Password must be at least 8 characters with one uppercase letter and one number.",
