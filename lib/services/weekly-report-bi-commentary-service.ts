// Weekly report — executive commentary from the BI agent.
//
...
//   - Future-proof: when the agent gets access to historical BI data
...
export interface BiWeeklyCommentary {
  ...
  actions: string[];
  // Provenance so the UI can label "Generated by BI agent at ...".
  agent: string;
  generatedAt: string;
}
